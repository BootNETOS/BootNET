...
public static class KeyboardEx
{
    ...
    public static bool TryReadKey(out ConsoleKeyInfo Key)
    {
        ...
        {
            Key = new ConsoleKeyInfo(KeyX.KeyChar, KeyX.Key.ToConsoleKey(), KeyX.Modifiers == ConsoleModifiers.Shift,
                KeyX.Modifiers == ConsoleModifiers.Alt, KeyX.Modifiers == ConsoleModifiers.Control);
            return true;
        }
