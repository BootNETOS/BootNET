...
/// <summary>
///     The <see cref="Mesh" /> class - Used to generate and load complet 3D shapes. Used in the <see cref="Engine" />
///     class.
///     <list type="table">
        ...
        while (Reader.BaseStream.Position < Reader.BaseStream.Length)
        {
            ...
            switch (Components[0])
            {
                ...
                case "v":
                    ...
                    if (Components.Length != 4) throw new FormatException("Invalid vertex format.");
                ...
                case "F":
                    // Throw error when an invalid input is detected.
                    if (Components.Length != 4) throw new FormatException("Invalid face format.");

                    var ComponentsV1 = Components[1].Split('/');
                    var ComponentsV2 = Components[2].Split('/');
                    var ComponentsV3 = Components[3].Split('/');
                    ...
                    try
                    {
                        Temp.Triangles.Add(new Triangle
                        {
