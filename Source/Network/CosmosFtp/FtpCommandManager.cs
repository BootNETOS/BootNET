...
internal class FtpCommandManager
{
    ...
    internal void ProcessPwd(FtpClient ftpClient, FtpCommand command)
    {
        ...
        var i = CurrentDirectory.IndexOf(":") + 2;
    ...
    internal void ProcessPasv(FtpClient ftpClient, FtpCommand command)
    {
        ...
        */
        ...
        ftpClient.SendReply(200,
            $"Entering Passive Mode ({address[0]},{address[1]},{address[2]},{address[3]},{port / 256},{port % 256})");
    ...
    internal void ProcessPort(FtpClient ftpClient, FtpCommand command)
    {
        ...
        ftpClient.Address = new Address((byte)int.Parse(splitted[0]), (byte)int.Parse(splitted[1]),
            (byte)int.Parse(splitted[2]), (byte)int.Parse(splitted[3]));
